...
public class ClientLoginHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        try {
            ...
            Map<String, AttributeValue> clientItem = queryResponse.items().get(0);
            String storedPasswordHash = clientItem.get("passwordHash").s();
