...
public class ClientGetMessagesHandler
  ...
  public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
    try {
      // Retrieve clientId and therapistId from the path parameters
      ...
      context.getLogger().log("Error in ClientGetMessagesHandler: " + e.getMessage());
