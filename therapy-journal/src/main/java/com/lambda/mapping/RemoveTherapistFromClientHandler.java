...
public class RemoveTherapistFromClientHandler
  ...
  public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
    try {
      ...
      if (pathParams == null || !pathParams.containsKey("clientId") || !pathParams.containsKey("therapistId")) {
        return createResponse(400, "{\"message\":\"Missing clientId or therapistId in path parameters\"}");
      }
      ...
      context.getLogger().log("Error removing therapist from client: " + e.getMessage());
      return createResponse(500, "{\"message\":\"Error removing therapist from client\"}");
    }
  }
